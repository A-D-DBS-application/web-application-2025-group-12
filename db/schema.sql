...
CREATE TABLE IF NOT EXISTS public.match (
  ...
  -- één en dezelfde combinatie niet twee keer (client + ground is uniek)
  CONSTRAINT uq_match_pair UNIQUE (client_id, ground_id)
);

CREATE INDEX IF NOT EXISTS idx_match_client    ON public.match(client_id);
